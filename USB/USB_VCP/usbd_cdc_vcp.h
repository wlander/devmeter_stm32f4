...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
uint16_t VCP_DataTx   (uint8_t* Buf, uint32_t Len);			// Передача байта по USB
void VCP_DataTx_   (uint8_t* Buf, uint32_t Len);
void OUT_DataTx_USB (void);			// Передача данных по USB
void OUT_DataTx_USB_Error (void);			// Передача ошибки по USB
